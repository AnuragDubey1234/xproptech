                    ...
                    {data.map((article, i) => (
                        ...
                        >
                            <Link href={`/news/${article.slug}`} className="block h-full group relative md:rounded-[2rem] rounded-xl overflow-hidden bg-neutral-900 shadow-sm md:shadow-xl hover:shadow-2xl transition-all duration-500 border border-neutral-200 dark:border-neutral-800 md:border-none">
                                ...
                                <div className="md:hidden absolute right-0 top-0 bottom-0 left-[120px] p-4 bg-white dark:bg-neutral-950 flex flex-col justify-center border-l border-neutral-100 dark:border-neutral-800">
                                    <div className="flex items-center gap-2 mb-1.5">
                                        <span className="text-[10px] font-bold text-fire-red uppercase tracking-wider bg-red-50 dark:bg-red-900/20 px-2 py-0.5 rounded-full">{article.category}</span>
                                    </div>
                                    <h3 className="text-sm font-bold text-neutral-900 dark:text-white leading-snug line-clamp-2 mb-1.5 tracking-tight group-hover:text-fire-red transition-colors">
                                        {article.title}
                                    </h3>
                                    <p className="text-xs text-neutral-500 dark:text-neutral-400 line-clamp-1 font-medium flex items-center gap-1">
