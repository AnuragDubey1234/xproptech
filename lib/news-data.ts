...
const IMAGES = {
    ...
    smart: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=600&q=80',
...
export const news: NewsArticle[] = [
    { slug: 'bangalore-proptech-summit-2026', title: 'Bangalore PropTech Summit 2026: Linking Future Tech', excerpt: 'Key industry leaders to gather in India\'s tech capital to discuss the future of real estate technology and innovation.', category: 'India Launches', image: IMAGES.tech, author: 'Rohan Sharma', date: 'Jan 30, 2026' },
    { slug: 'hyderabad-office-tech-boom', title: 'Hyderabad Office Tech Boom: Smart Workspaces Rise', excerpt: 'Demand for IoT-enabled office spaces surges in HITEC City as tech giants expand footprint.', category: 'India Launches', image: IMAGES.office, author: 'Neha Singh', date: 'Jan 29, 2026' },
    { slug: 'mumbai-redevelopment-tech', title: 'Mumbai Redevelopment: Tech-Driven Project Management', excerpt: 'Dharavi redevelopment project adopts advanced BIM and project tracking tools for efficiency.', category: 'India Launches', image: IMAGES.construction, author: 'Vikram Reddy', date: 'Jan 28, 2026' },
    { slug: 'gurgaon-luxury-home-automation', title: 'Gurgaon Luxury: Home Automation Standard in New Launches', excerpt: 'Developers mandate smart home features in all upcoming premium residential projects.', category: 'India Launches', image: IMAGES.smart, author: 'Priya Mehta', date: 'Jan 27, 2026' },
    { slug: 'chennai-logistics-parks-digitization', title: 'Chennai Logistics Parks: Digital Warehousing Push', excerpt: 'New industrial parks integrate automated storage and retrieval systems to boost efficiency.', category: 'India Launches', image: IMAGES.city, author: 'Arjun Kapoor', date: 'Jan 26, 2026' },
    { slug: 'pune-proptech-incubator', title: 'Pune Launches First Dedicated PropTech Incubator', excerpt: 'City initiative to support early-stage startups solving urban real estate challenges.', category: 'India Launches', image: IMAGES.startup, author: 'Rohan Sharma', date: 'Jan 25, 2026' },
    { slug: 'noida-airport-land-tech', title: 'Noida Airport Region: Land Acquisition Tech Platform', excerpt: 'Government pilots blockchain-based land acquisition system for transparency around Jewar Airport.', category: 'India Launches', image: IMAGES.green, author: 'Vikram Reddy', date: 'Jan 24, 2026' },
    { slug: 'kolkata-green-building-incentives', title: 'Kolkata Green Building: Tech for Sustainability', excerpt: 'New policy incentivizes developers using green tech and energy-efficient designs.', category: 'India Launches', image: IMAGES.green, author: 'Neha Singh', date: 'Jan 23, 2026' },
    { slug: 'ahmedabad-gift-city-fintech-proptech', title: 'GIFT City: Fintech-PropTech Convergence Hub', excerpt: 'Cross-border real estate investment platforms find a home in India\'s first IFSC.', category: 'India Launches', image: IMAGES.finance, author: 'Priya Mehta', date: 'Jan 22, 2026' },
    { slug: 'kochi-waterfront-smart-city', title: 'Kochi Smart Waterfront: IoT for Urban Management', excerpt: 'Smart city project integrates water level monitoring and urban planning tech.', category: 'India Launches', image: IMAGES.city, author: 'Arjun Kapoor', date: 'Jan 21, 2026' },
    { slug: 'jaipur-heritage-proptech', title: 'Jaipur Heritage: 3D Mapping for Conservation', excerpt: 'PropTech startup maps historical sites for preservation and virtual tourism.', category: 'India Launches', image: IMAGES.vr, author: 'Rohan Sharma', date: 'Jan 20, 2026' },
